...
@unless($item->archived_at)
    <div id="archive-confirm-modal" class="fixed inset-0 z-50 hidden items-center justify-center bg-gray-900/35 p-4 backdrop-blur-[1px]" role="dialog" aria-modal="true" aria-labelledby="archive-confirm-modal-title">
        <div class="w-full max-w-md rounded-xl bg-white p-6 shadow-lg">
            <div class="text-center">
