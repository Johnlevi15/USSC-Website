...
<header class="sticky top-0 z-40 border-b-2 border-yellow-500 bg-red-950 text-white shadow-md">
    ...
    <nav class="border-t border-red-900 bg-red-900">
        <div class="mx-auto flex max-w-7xl gap-1 overflow-x-auto px-4 text-xs font-semibold">
            ...
            <a href="{{ route('admin.document-types.index') }}" class="whitespace-nowrap px-4 py-2.5 {{ request()->routeIs('admin.document-types.*') ? 'border-b-2 border-yellow-400 text-yellow-400' : 'text-gray-200 hover:text-white' }}"><i class="fa-solid fa-list-check mr-1"></i>Document Types</a>
